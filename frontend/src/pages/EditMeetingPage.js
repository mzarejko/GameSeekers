...
class EditMeetingPage extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            meeting_date: props.location.state.meeting_date,
            address: props.location.state.address,
            currentUser: localStorage.getItem('currentUser'),
            status: props.location.state.status,
            number_of_participants: props.location.state.number_of_participants,
    ...
    handleSubmit = (e) => {
        ...
        try {
            fetch(
                "https://game-seekers-backend.herokuapp.com/v1/room/" + this.state.room_name + "/meeting/" + this.state.id + "/", {
        ...
        return (
            <div className="meeting-form">
                <form onSubmit={this.handleSubmit}>
                    ...
                    <button className='btn' type="submit">Zmień</button>
                </form>
                <Prompt
